...
type User struct {
	UserId        int64       `orm:"auto;rel(fk)" description:"用户编号"`
	...
	Status        int         `orm:"default(2)" form:"Status" valid:"Range(1,2)" description:"状态：1正常2禁止"`
	...
	Department    *Department `orm:"rel(fk)" description:"部门编号"`
